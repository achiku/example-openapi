...
func (s *Server) decodeUploadFileRequest(r *http.Request) (
	...
	case ct == "multipart/form-data":
		...
		var request OptUploadFileReq
		{
			var optForm UploadFileReq
			q := uri.NewQueryDecoder(form)
			{
				cfg := uri.QueryParameterDecodingConfig{
				...
				if err := q.HasParam(cfg); err == nil {
					if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
						var optFormDotAdditionalMetadataVal string
						if err := func() error {
							val, err := d.DecodeValue()
							if err != nil {
								return err
							...
							optFormDotAdditionalMetadataVal = c
							return nil
						}(); err != nil {
							return err
						}
						optForm.AdditionalMetadata.SetTo(optFormDotAdditionalMetadataVal)
						return nil
					}); err != nil {
						return req, close, errors.Wrap(err, "decode \"additionalMetadata\"")
					}
				}
			}
			{
