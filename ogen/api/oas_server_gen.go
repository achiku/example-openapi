...
type Handler interface {
	...
	//
	// POST /store/order
	PlaceOrder(ctx context.Context, req *Order) (PlaceOrderRes, error)
	...
	UploadFile(ctx context.Context, req OptUploadFileReq, params UploadFileParams) (*ApiResponse, error)
}
